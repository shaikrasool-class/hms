...
public class PatientPdfDocumentView {
	...
	public static ByteArrayInputStream patientPdfReport(PatientDto patient, DoctorDto doctor, HospitalDto hospital) {
		...
		try {
			 ...
			 * BarcodeQRCode("Muhammed Hashir:) The New Year is here! Look ahead, embark on the road to success. May you have a great journey to your destination! Happy 2020."
